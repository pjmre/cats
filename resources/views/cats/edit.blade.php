    ...
    <div class="container pt-3">
        ...
        <form action="{{route('cats.update', ['cat'=>$cat->id])}}" method="POST">
            ...
            <div class="mb-3">
                ...
                @enderror
                <label for="tag" class=select-picker">Tags</label>
                <select class="form-select" id="tag" multiple name="tag" required multiple>
                    <option value="1">Heterochromia</option>
                    <option value="2">Without a tail</option>
                    <option value="3">Mixed blood</option>
                    <option value="4">Agressive</option>
